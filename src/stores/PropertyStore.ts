...
interface PropertyState {
  ...
  fetchSliderApartments: (price?: string, location?: string) => Promise<void>;
   ...
   fetchHomeChalets: (price?: string, location?: string) => Promise<void>;

  fetchHomeApartments: (price?: string, location?: string) => Promise<void>;
...
export const usePropertyStore = create<PropertyState>((set) => ({
  ...
  fetchHomeChalets: async (price?: string, location?: string) => {
    set({ loading: true, error: null });
  ...
  fetchSliderApartments: async (price?: string, location?: string) => {
   ...
   fetchHomeApartments: async (price?: string, location?: string) => {
    set({ loading: true, error: null });
