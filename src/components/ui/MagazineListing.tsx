                ...
                <div className="container mx-auto">
                    ...
                    <div className="px-[16px] sm:px-0 flex md:justify-between w-full md:items-end flex-col md:flex-row gap-6.5">
                        ...
                        <div className='sm:w-auto w-full'>
                            <Link href="/magazine" >
                                <button className='sm:w-auto w-full cursor-pointer md:py-3 md:px-6 py-2 px-4 font-medium text-[#121212] rounded-[9999px] bg-white border border-[#e3e3e3]'>View All Articles</button>
                            </Link>
                        </div>
                    </div>
