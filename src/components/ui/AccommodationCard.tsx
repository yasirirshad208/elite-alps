...
type AccommodationCard = {
    ...
    stars?: string
    id?: string
    checkin?: string; // Add checkin prop to determine if specific date is selected
};
...
const AccommodationCard = ({ 
    ...
    // Determine if we should show "Starts From" text
    // If checkin is provided and not empty, it means a specific date is selected
    const showStartsFrom = !checkin || checkin.trim() === '';
        ...
        <div className="rounded-[12px] bg-white border border-[#E3E3E3] p-[6px] cursor-pointer">
            ...
            <Link href={link}>
                <div className='mt-2 px-2'>
                    ...
                    {/* Conditionally render "Starts From" text */}
                    {showStartsFrom && (
