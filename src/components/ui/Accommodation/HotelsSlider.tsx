...
import { Hotel } from './HotelListing';

const HotelsSlider = ({ hotels }: { hotels: Hotel[] }) => {
        ...
        <section className='md:mt-8 mt-6'>
            ...
            <div className="container">
                ...
                <div className="flex md:justify-between md:items-end flex-col md:flex-row gap-6.5">
                    <div>
                        <div className="heading-h1 text-[#121212] leading-[120%] my-2">Suggested Hotels</div>
                        <div className="text-[#666D80] font-medium">
                            The best hotels which are listed here for our best service.
                        </div>
                    </div>
