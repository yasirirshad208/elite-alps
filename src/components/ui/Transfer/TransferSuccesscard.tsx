...
const TransferSuccessCard = ({onClose }: Props) => {
        ...
        <div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='text-[14px] text-[#666D80] sm:px-4 px-2 text-center'>
                    Our travel specialist will contact you shortly to finalise your transfer details.
                </div>
            </div>
            <div className='w-full h-[1px] bg-[#e3e3e3] my-3'></div>
            <div className='mt-3 flex flex-col gap-2'>

                <div className='text-[#121212] font-[600] text-[12px] mb-2 text-center'>While we prepare your journey, discover our collection of luxury chalets to complete your Alpine experience.</div>
                <Link href={"/chalets"}>
                    <button
                        type="submit"
