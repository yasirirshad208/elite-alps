...
const BookAccommodationSkeleton = () => {
    return (
            ...
            <section className=" container">
                ...
                <div className="flex gap-10 md:justify-between md:flex-row flex-col">
                    ...
                    <div className="w-full md:max-w-[888px] pl-3">
                        ...
                        <div className="mb-10">
                            ...
                            <div className="flex flex-col gap-3">
                                {Array.from({ length: 3 }).map((_, i) => (
                                    <div
                                        key={i}
                                        className="border border-[#e3e3e3] rounded-[12px] p-3 flex items-center justify-between"
                                    >
                                        <Skeleton width={140} height={16} />
                                        <Skeleton width={80} height={32} className="rounded-[12px]" />
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        {/* FAQs */}
                        <div className="mb-12">
                            <Skeleton width={140} height={26} className="mb-4" />
                            {Array.from({ length: 3 }).map((_, i) => (
                                <Skeleton key={i} height={40} className="rounded-[8px] mb-3" />
                            ))}
                        </div>
                    </div>
...
export default BookAccommodationSkeleton;
