                ...
                <div className="sm:container mx-auto">
                    ...
                    <div className="sm:block hidden">
                        <div className="flex items-center gap-1 container">
                            <Link href={"/chalets"} className="text-[#666d86] font-regular underline">Chalets</Link>
                            <IoIosArrowBack className="text-[#121212]" />
                            <span className="text-[#121212] font-regular">Detailed Chalet</span>
                        </div>
                    </div>
            ...
            <section >
                <div className="container mx-auto">
                    <div className="flex gap-10 md:justify-between md:flex-row flex-col">
                        ...
                        <div className="md:max-w-[484px] sm:block hidden w-full">
                            <div
